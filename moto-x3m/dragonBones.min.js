                        ...
                        if (u !== null) {
                            for (var _ = 0, m = u; _ < m.length; _++) {
                                ...
                                switch (p.type) {
                                    case 10:
                                        {
                                            var n = t.BaseObject.borrowObject(t.BoneAllTimelineState);n.bone = h;n.bonePose = f;n.init(this._armature, this, p);this._boneTimelines.push(n);
                                            break
                                        }
                                    case 11:
                                        {
                                            var n = t.BaseObject.borrowObject(t.BoneTranslateTimelineState);n.bone = h;n.bonePose = f;n.init(this._armature, this, p);this._boneTimelines.push(n);
                                            break
                                        }
                                    case 12:
                                        {
                                            var n = t.BaseObject.borrowObject(t.BoneRotateTimelineState);n.bone = h;n.bonePose = f;n.init(this._armature, this, p);this._boneTimelines.push(n);
                                            break
                                        }
                                    case 13:
                                        {
                                            var n = t.BaseObject.borrowObject(t.BoneScaleTimelineState);n.bone = h;n.bonePose = f;n.init(this._armature, this, p);this._boneTimelines.push(n);
                                            break
                                        }
                                    default:
                                        break
                        ...
                        if (u !== null) {
                            for (var P = 0, M = u; P < M.length; P++) {
                                ...
                                switch (p.type) {
                                    case 20:
                                        {
                                            var n = t.BaseObject.borrowObject(t.SlotDislayTimelineState);n.slot = O;n.init(this._armature, this, p);this._slotTimelines.push(n);x = true;
                                            break
                                        }
                                    case 21:
                                        {
                                            var n = t.BaseObject.borrowObject(t.SlotColorTimelineState);n.slot = O;n.init(this._armature, this, p);this._slotTimelines.push(n);B = true;
                                            break
                                        }
                                    case 22:
                                        {
                                            var n = t.BaseObject.borrowObject(t.SlotFFDTimelineState);n.slot = O;n.init(this._armature, this, p);this._slotTimelines.push(n);g.push(n.meshOffset);
                                            break
                                        }
                                    default:
                                        break
                        ...
                        if (u !== null) {
                            for (var X = 0, V = u; X < V.length; X++) {
                                ...
                                switch (p.type) {
                                    case 30:
                                        {
                                            var n = t.BaseObject.borrowObject(t.IKConstraintTimelineState);n.constraint = Y;n.init(this._armature, this, p);this._constraintTimelines.push(n);
                                            break
                                        }
                                    default:
                                        break
